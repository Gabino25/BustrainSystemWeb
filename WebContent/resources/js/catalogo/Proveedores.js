	...
	function accionCatProv(pAccion){
		...
		if("Buscar"==pAccion){
			...
			if(varTablRO.$('tr.danger').length>0){
				var objClaveProveedor = varTablRO.$('tr.danger')[0].cells[0].childNodes[0].nodeValue; 
				var objClaveProveedorTrx = document.getElementById("claveProveedorTrx"); 
				objClaveProveedorTrx.value = objClaveProveedor;
