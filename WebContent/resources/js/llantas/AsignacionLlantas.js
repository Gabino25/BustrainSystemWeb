...
$(document).ready(function() {
	 ...
	 $("#resetFormId").hide();
	  varTablRO = $('#TablRO').DataTable( {
	        ...
	        "columns": [
	    	    { "orderable": true },   /*(1) Folio*/
	    	    { "orderable": false },  /*(2)*/
	    	    { "orderable": false },  /*(3)*/
	    	    { "orderable": false },  /*(4)*/
	    	    { "orderable": false },  /*(5)*/
	    	    { "orderable": false },  /*(6) Unidad*/
	    	    { "orderable": false },  /*(7)*/
	    	    { "orderable": false },  /*(8)*/
	    	    { "orderable": false },  /*(9)*/
	    	    { "orderable": false },  /*(10)*/
...
function environmentNueva(){
	...
	document.getElementById("inputselectLlantaId").focus();
	...
	if(e.type=="keypress"){
	  if(e.code=="Enter"){
		...
		if("fecha"==varTargetId){
			...
			document.getElementById("presionActual").focus();
		}else if("presionActual"==varTargetId){
			document.getElementById("nota").focus();
		}else if("nota"==varTargetId){
...
function eventLlantaHandle(e){
	if(e.type=="keypress"){
	 if("Enter"==e.code||"Tab"==e.code){
		 e.preventDefault(); 
		 objinputselectOperadorId = document.getElementById("inputselectOperadorId"); 
		 objinputselectOperadorId.focus(); 
		 return;
     }
	}
}
