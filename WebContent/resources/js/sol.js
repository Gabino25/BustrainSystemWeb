...
(function ($, window, document) {
    ...
    SearchableOptionList.prototype = {
        ...
        defaults: {
            ...
            texts: {
                noItemsAvailable: 'No se encontraron valores',
                selectAll: 'Select all',
                selectNone: 'Select none',
                quickDelete: '&times;',
                searchplaceholder: 'Presione aqui para buscar',
        ...
        _initializeUiElements: function () {
            ...
            var xxbsOriginalElementId = this.$originalElement[0].id;
            
            this.$input = $('<input id="input'+xxbsOriginalElementId+'" type="text" disabled/>')
            ...
            this.$innerContainer = $('<div id="solInnerContainer'+xxbsOriginalElementId+'" class="sol-inner-container"/>').append($inputContainer).append(this.$caret);
            ...
            this.$container = $('<div id="solSelection'+xxbsOriginalElementId+'" class="sol-container"/>')
                .hide()
        ...
        _initializeInputEvents: function () {
            ...
            this.$container
                .on('keydown', function (e) {
                    ...
                    console.log(!self.$noResultsItem.is(':visible'));
