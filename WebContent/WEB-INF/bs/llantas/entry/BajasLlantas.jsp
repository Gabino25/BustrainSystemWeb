...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/llantas/BajasLlantas.js"></script>
</head>
<body>

<jsp:include page="/WEB-INF/commons/header.jsp"/>
<div id="moduloPantallaDiv" class="modPantDiv">
 Llantas - Baja de Llanta
</div>
...
<form id="formMovimientosLlantas" method="post" action="${pageContext.request.contextPath}/BajasLlantasCO" onsubmit="return validaFormulario(this);" autocomplete="off">
<table id="TablInputs">
<tr>
...
<tr>
<td colspan="4"><textarea rows="2" cols="80" id="observaciones" name="observaciones" required></textarea></td>
</tr>
</table>
...
<td><button id="NuevaBtn" class="btn btn-primary" onclick="accionBajasLlantas('Nueva');">Nueva</button></td>
<td><button id="GuardarBtn" class="btn btn-primary" onclick="accionBajasLlantas('Guardar');">Guardar</button></td>
<td><button id="BorrarBtn" class="btn btn-primary" onclick="accionBajasLlantas('Borrar');">Borrar</button></td>
<% } %>
<td><button id="BuscarBtn" class="btn btn-primary" onclick="accionBajasLlantas('Buscar');">Buscar</button></td>
<% if ("0".equals((String)request.getAttribute("rAttrNivel"))) { %>
<td><button id="ModificarBtn" class="btn btn-primary" onclick="accionBajasLlantas('Modificar');">Modificar</button></td>
<td><button id="CancelarBtn" class="btn btn-primary" onclick="accionBajasLlantas('Cancelar');">Cancelar</button></td>
<% } %>
<td><button id="SalirBtn" class="btn btn-primary" onclick="accionBajasLlantas('Salir');">Salir</button></td>
</tr>
</table>
