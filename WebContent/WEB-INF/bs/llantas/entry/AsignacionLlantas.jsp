...
<head>
<meta charset="UTF-8">
<title>Asignacion&nbsp;Llantas</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/llantas/AsignacionLlantas.js"></script>
...
<form id="formMovimientosLlantas" method="post" action="${pageContext.request.contextPath}/AsignacionLlantasCO" onsubmit="return validaFormulario(this);" autocomplete="off">
<table id="TablInputs">
<tr>
...
<td><input type="number" id="presionActual" name="presionActual" required/></td>
</tr>
<tr>
<td>
...
<input type="hidden" name="movLlantaTrx" id="movLlantaTrx"/>
</form>
</fieldset>
...
<td><button id="NuevaBtn"  class="btn btn-primary" onclick="accionAsignacionLlantas('Nueva');">Nueva</button></td>
<td><button id="GuardarBtn" class="btn btn-primary" onclick="accionAsignacionLlantas('Guardar');">Guardar</button></td>
<td><button id="BorrarBtn" class="btn btn-primary" onclick="accionAsignacionLlantas('Borrar');">Borrar</button></td>
<% } %>
<td><button id="BuscarBtn" class="btn btn-primary" onclick="accionAsignacionLlantas('Buscar');">Buscar</button></td>
<% if ("0".equals((String)request.getAttribute("rAttrNivel"))) { %>
<td><button id="ModificarBtn" class="btn btn-primary" onclick="accionAsignacionLlantas('Modificar');">Modificar</button></td>
<td><button id="CancelarBtn" class="btn btn-primary" onclick="accionAsignacionLlantas('Cancelar');">Cancelar</button></td>
<% } %>
<td><button id="SalirBtn" class="btn btn-primary" onclick="accionAsignacionLlantas('Salir');">Salir</button></td>
</tr>
</table>
