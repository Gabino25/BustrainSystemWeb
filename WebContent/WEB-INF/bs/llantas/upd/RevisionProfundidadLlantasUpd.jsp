...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/llantas/upd/RevisionProfundidadLlantasUpd.js"></script>
</head>
<body>
...
<form id="formUpd" action="${pageContext.request.contextPath}/RevisionProfundidadLlantasCO" method="post">
<table id="TablInputs">
<tr>
...
<tr>
<td colspan="4"><textarea rows="2" cols="80" id="observaciones" name="observaciones" >${movimientoLlanta.observaciones}</textarea></td>
</tr>
</table>
